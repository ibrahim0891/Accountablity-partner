        ...
        <Page>
            ...
            <Card className="text-my-green-900">
                ...
                <p>
                    ...
                    <span
                        className="text-lg"> {user.transactions.reduce((acc, t) => acc + t.amount, 0).toFixed(2)} Tk</span>
                </p>
            </Card>

            <Card className="text-my-green-900">
                <h2 className="text-xl font-semibold tracking-tight  mb-4">Compensation Timeline</h2>
