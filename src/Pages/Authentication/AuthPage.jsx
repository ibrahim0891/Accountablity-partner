    ...
    return (
        <div className="w-full h-screen md:h-full flex items-center justify-center  bg-my-green-900 p-6">
            <Card className="  flex flex-col items-center justify-center gap-6 ">
                ...
                <form className="  flex flex-col items-center justify-center gap-6 text-green-800  "
                    ...
                    <h1 className="text-4xl font-bold "> {isLogin ? "Log in " : 'Sign Up'} </h1>
                    {
                        !isLogin && <div className="flex flex-col gap-2 w-full">
                            ...
                            <input type="text" placeholder="Jhon doe"
                                   className="px-4 py-2 border border-gray-200 rounded-full bg-lime-50 focus:outline-my-green-200 focus:outline-4 focus:outline-none focus:text-green-900  "
                    ...
                    {actionMessage ? <div
                        className={" text-red-900 -my-2 p-2 px-2 rounded-md w-full " + `${actionMessage.status == 201 ? "bg-green-100 text-green-700" : "bg-red-100"}`}>
                    ...
                    <button type="submit"
                            className="px-4 py-2 text-white text-lg w-full bg-my-green-800  hover:bg-green-800 rounded-full">  {actionMessage.status == 201 &&
                        <Navigate to={'/'}/>} {isLogin ? "Log in " : "Sign Up"}</button>
                </form>
                <div className="text-center space-y-4">
                    ...
                    <div className="space-x-3 flex text-nowrap flex-col">
                        ...
                        <span className="text-my-green-900 underline hover:underline cursor-pointer"
