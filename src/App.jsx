...
function App() {
    ...
    return (
        ...
        <>
            ...
            <div className="relative md:w-96 md:aspect-[1/2] mx-auto rounded-[32px] shadow-2xl shadow-gray-400/50 hover:shadow-gray-400/70 transition-shadow md:mt-12 md:border-8 md:border-gray-900 flex flex-col ring-8 ring-my-green-500/10 hover:ring-my-green-500  ring-offset-8 hover:ring-offset-0">
            ...
            <button className="animate-pulse fixed bottom-0 left-0 m-6 text-my-green-500" onClick={() => setWhatsNewVisible(true)}> <Info size={42}> </Info></button>
            {whatsNewVisible &&
                <div>
                    <div className="fixed inset-0 z-10 bg-black/40 backdrop-blur-sm transition-all duration-300" onClick={() => { setWhatsNewVisible(false) }}> </div>
                    <div className="fixed bottom-0 left-0 right-0  rounded-3xl  w-80 p-8 border m-6 bg-my-green-100 z-20">
                        <div className="flex justify-between items-center w-full pb-4">
                            <h1 className="text-2xl font-semibold text-my-green-800"> What's New! v1.2</h1>
                            <X size={20} className="text-my-green-400 hover:text-my-green-700" onClick={() => setWhatsNewVisible(false)}></X>
                        </div>
                        <p>
                        ...
                        <button className="w-full mt-6 px-4 py-3 text-sm font-extrabold text-my-green-100 bg-my-green-500  hover:shadow-lg rounded-full transition-all duration-300 transform hover:scale-[1.02] focus:outline-none focus:ring-2 focus:ring-my-green-400 focus:ring-opacity-50" onClick={() => setWhatsNewVisible(false)}>
                            Cool!! 😎
                        </button>
                    </div>
                </div>
