...
function App() {
    ...
    return (
        ...
        {/* android Device Frame  */}
            <div className="relative h-[720px] aspect-[9/18] mx-auto rounded-[32px] shadow-2xl shadow-gray-400/50 hover:shadow-gray-400/70 transition-shadow mt-12 border-8 border-gray-900 flex flex-col">
